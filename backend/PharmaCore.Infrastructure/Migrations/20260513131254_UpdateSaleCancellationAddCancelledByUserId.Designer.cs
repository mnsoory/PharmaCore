...
namespace PharmaCore.Infrastructure.Migrations
{
    ...
    [Migration("20260513131254_UpdateSaleCancellationAddCancelledByUserId")]
    partial class UpdateSaleCancellationAddCancelledByUserId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmaCore.Core.Entities.DrugAlternative", b =>
                {
                    b.Property<int>("DrugId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AlternativeDrugId", "DrugId")
                        .IsUnique();

                    b.ToTable("DrugAlternatives", t =>
                        {
                            t.HasCheckConstraint("CK_DrugAlternative_NoSelfAlternative", "[DrugId] <> [AlternativeDrugId]");

                            t.HasCheckConstraint("CK_DrugAlternative_UniqueSymmetricPair", "[DrugId] < [AlternativeDrugId]");
                        });
                });
            ...
            modelBuilder.Entity("PharmaCore.Core.Entities.Sale", b =>
                {
            ...
            modelBuilder.Entity("PharmaCore.Core.Entities.SaleCancellation", b =>
                {
                    b.Property<int>("SaleCancellationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SaleCancellationId"));
            ...
            modelBuilder.Entity("PharmaCore.Core.Entities.SaleItem", b =>
                {
            ...
            modelBuilder.Entity("PharmaCore.Core.Entities.StockSetting", b =>
                {
                    b.Property<int>("DrugId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("StockSettings", (string)null);
                });
            ...
            modelBuilder.Entity("PharmaCore.Core.Entities.DrugAlternative", b =>
                {
                    b.HasOne("PharmaCore.Core.Entities.Drug", "AlternativeDrug")
                        .WithMany()
            ...
            modelBuilder.Entity("PharmaCore.Core.Entities.SaleCancellation", b =>
                {
                    b.HasOne("PharmaCore.Core.Entities.User", "CancelledByUser")
                        .WithMany()
                        .HasForeignKey("CancelledByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PharmaCore.Core.Entities.Sale", "Sale")
                        .WithOne("Cancellation")
                        .HasForeignKey("PharmaCore.Core.Entities.SaleCancellation", "SaleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("PharmaCore.Core.Entities.SaleItem", b =>
                {
                    b.HasOne("PharmaCore.Core.Entities.StockBatch", "Batch")
                        .WithMany("SaleItems")
            ...
            modelBuilder.Entity("PharmaCore.Core.Entities.StockSetting", b =>
                {
                    b.HasOne("PharmaCore.Core.Entities.Drug", "Drug")
                        ...
                        .HasForeignKey("PharmaCore.Core.Entities.StockSetting", "DrugId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
